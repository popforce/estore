...
/**
 * eStore_Demo_Importer Class.
 */
class eStore_Demo_Importer {
	...
	public function __construct() {
		$this->plugin_data = array(
			...
			'name' => __( 'ThemeGrill Demo importer', 'estore' ),
		);
	...
	public function add_admin_menu() {
		add_theme_page( __( 'Demo Importer', 'estore' ), __( 'Demo Importer', 'estore' ), 'switch_themes', 'demo-importer', array( $this, 'demo_importer' ) );
	}
